...
if __name__ == "__main__":
    n1 = 5
    print(climbing_stairs_backtrack(n1))
    print(climbing_stairs_dfs(n1))
    print(climbing_stairs_dfs_mem(n1))
    print(climbing_stairs_dp(n1))
    print(climbing_stairs_dp_comp(n1))
